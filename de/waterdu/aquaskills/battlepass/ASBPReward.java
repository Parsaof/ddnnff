...
public class ASBPReward
{
    ...
    public ASBPReward(final int index, final String[] freeRewards, final RewardDisplay freeDisplay, final String freeMessage, final String[] premiumRewards, final RewardDisplay premiumDisplay, final String premiumMessage) {
    ...
    public void execute(final EntityPlayerMP player, final String[] rewards, final String message) {
        ...
        player.sendMessage((ITextComponent)new TextComponentString(Config.format("prefixASBPNeutral", new Object[0]) + message.replace("&", "§")));
    }
